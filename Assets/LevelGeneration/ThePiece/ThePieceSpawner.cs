...
namespace LevelGeneration.ThePiece
{
    ...
    public class ThePieceSpawner : MonoBehaviour
    {
        ...
        {
            LevelPiecePositioner positioner = piece.GetComponent<LevelPiecePositioner>(); //need THE piece positioner??
        ...
        {
            Vector3 spawnPosition = entryPoint + Vector3.up * 3.5f + Vector3.left * 2.7f + Vector3.forward * 2; //magic
