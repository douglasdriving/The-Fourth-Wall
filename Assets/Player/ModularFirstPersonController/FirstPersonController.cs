...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (enableJump && Input.GetKeyDown(jumpKey) && groundUnderPlayer)
        {
            Jump();
        }
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            // Will allow head bob
            if (targetVelocity.x != 0 || targetVelocity.z != 0 && groundUnderPlayer)
            {
                isWalking = true;
            }
            else
    ...
    private void Jump()
    {
        ...
        if (groundUnderPlayer)
        {
            ...
            OnJumped?.Invoke(groundUnderPlayer);
            groundUnderPlayer = null;
        }
